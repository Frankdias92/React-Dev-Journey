...
import { ActionTypes, CycleAction, addNewCycleAction, interruptCycleAction } from "../reduces/cycles/actions";
...
export function CycleContextProvider({
  ...
  function markCurrentAsFinished() {
    dispatch({ type: ActionTypes.MARK_CURRENT_CYCLE_AS_FINISHED } as CycleAction);
  }
